          ...
          <section className=" w-11/12 text-center space-y-8 py-10 mx-auto">
            <div className="container w-full">
              <div className="flex flex-col">
                <div className="left-card w-full bg-white border-2 border-mediumGray rounded-lg flex flex-col justify-between gap-6">
                  {/* left */}

                  <div className="flex flex-col gap-3 w-full border-b-2 border-mediumGray p-5">
                    <div className="bg-lightGray p-6 rounded-lg ">
                      <img src={PinkShoe} alt="pink shoe" />
                    </div>
                  ...
                  <div className="w-full">
                    {/* first div */}
                    <div className="w-full flex justify-between py-4 border-b-2 border-mediumGray ">
                      <div className=" w-full text-start space-y-2 pb-2 flex flex-col items-center justify-center">
                        <h3 className="font-bold text-2xl tracking-[0.2em]">
                          Burberry Shine
                        </h3>
                        <p>
                    ...
                    <div className="flex justify-between items-center p-5 border-b-2 border-mediumGray ">
                      <p className="font-semibold text-primaryGray">Overview</p>
                    ...
                    <div className="flex justify-between items-center p-5 border-b-2 border-mediumGray ">
                      <p className="font-semibold text-primaryGray">Warranty</p>
                      <img src={DownArrow} alt="icon" />
                    </div>
                    <div className="flex justify-between items-center p-5 border-b-2 border-mediumGray ">
                      <p className="font-semibold text-primaryGray">Reviews</p>
                      <img src={DownArrow} alt="icon" />
                    </div>
                    ...
                    <div className="p-5">
                      ...
                      <div className="cards w-full my-5 flex items-center gap-6 overflow-hidden">
                        <div className="card w-[30%] min-w-[300px]">
                          <div className="border-2 rounded-lg border-mediumGray p-4 w-full">
                            <div className="space-y-2">
                              <div className="bg-lightGray rounded-lg ">
